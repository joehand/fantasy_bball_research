...
/* **************
    Player AutoComplete Using Typeahead.js
*****************/
var players = new Bloodhound({
  ...
  prefetch: {
    ...
    filter: function(list) {
      return $.map(list['items'], function(player) { return { name: player }; });
    }
  }
});
...
// options being used
$('#player-search.typeahead').typeahead(null, {
  name: 'players',
  displayKey: 'name',
